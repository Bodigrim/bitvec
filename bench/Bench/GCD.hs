...
benchGCD k = bgroup (show (1 `shiftL` k :: Int))
  [ bench "Bit/gcdExt"    $ nf (uncurry (*)) (   toF2Poly $ randomVec    Bit k,    toF2Poly $ randomVec'    Bit k)
  , bench "Bit.TS/gcdExt" $ nf (uncurry (*)) (TS.toF2Poly $ randomVec TS.Bit k, TS.toF2Poly $ randomVec' TS.Bit k)
  ]
